System.register(["./Authenticate", "./User", "./DailyNote", "./Post", "./PostGOB", "./Posts", "./PostsGOB", "./PostAsk", "./PostAsks", "./Chat", "./HomeDailyNote", "./HomeHelpCenter", "./RegisteredDaily"], function (exports_1, context_1) {
    "use strict";
