System.register(["./controllers/DailyNoteController", "./utils/userData"], function (exports_1, context_1) {
    "use strict";
    var DailyNoteController_1, userData_1, userData, dayliesResult, cadastrar, dailyesResult, cancel, listDate, controller;
    ...
    return {
        ...
        execute: function () {
            ...
            if (dayliesResult)
                dayliesResult.addEventListener('click', controller.showAllDailys.bind(controller));
            $(document).ready(() => document.getElementById('dayliesResult').click());
        }
    };
});
