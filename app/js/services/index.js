System.register(["./DailyNoteService", "./AuthenticateService", "./UserService", "./HelpCenterService", "./HelpCenterServiceAsk", "./HelpCenterGOBService"], function (exports_1, context_1) {
    "use strict";
