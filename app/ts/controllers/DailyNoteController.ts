...
export class DailyNoteController {
    ...
    constructor() {
        ...
        this.impediment = <HTMLInputElement>(
            document.querySelector('#impediment')
        )
        this.date = <HTMLInputElement>document.querySelector('#date')

        this.listDate = <HTMLInputElement>document.querySelector('#filter')

        this.editYesterday = <HTMLInputElement>(
            document.querySelector('#edit-yesterday')
        )
        this.editToday = <HTMLInputElement>document.querySelector('#edit-today')
        this.editImpediment = <HTMLInputElement>(
            document.querySelector('#edit-impediment')
        )
        // init validations
        this.addVals = [
