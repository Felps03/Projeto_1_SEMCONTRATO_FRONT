...
},{}],"js/user-login-utils.js":[function(require,module,exports) {
"use strict";
...
function updatePassValidator() {
  var accmodalpassword = document.querySelector("#modalpassword");
  var modalpassword = document.getElementById('modalpassword').value;
  var modalpasswordmessage = document.querySelector("#modalpasswordvalidator");

  if (modalpassword == null || modalpassword.length < 6 || modalpassword.length > 8 || (0, _index2.hasSpace)(modalpassword) || (0, _index2.hasSolitaryChar)(modalpassword)) {
  ...
  var accmodalnewpassword = document.querySelector("#modalnewpassword");
  var modalnewpassword = document.getElementById('modalnewpassword').value;
  var modalnewpasswordmessage = document.querySelector("#modalnewpasswordvalidator");

  if (modalnewpassword == null || modalnewpassword.length < 6 || modalnewpassword.length > 8 || (0, _index2.hasSpace)(modalnewpassword) || (0, _index2.hasSolitaryChar)(modalnewpassword)) {
  ...
  var accmodalnewpasswordConfirm = document.querySelector("#modalnewpasswordConfirm");
  var modalnewpasswordConfirm = document.getElementById('modalnewpasswordConfirm').value;
  var modalnewpasswordmessageConfirm = document.querySelector("#modalnewpasswordconfirmvalidator");
...
access.addEventListener('click', function (event) {
  ...
  _jquery.default.ajax({
    type: "POST",
    url: "".concat(_index.HOST, "users/authenticate"),
    data: {
      "email": email,
      "password": password
    },
    ...
    error: function error(request, status, _error, data) {
      console.log(_error);
      alertco(data);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/user-login-utils.js"], null)
//# sourceMappingURL=/user-login-utils.b12315c6.js.map