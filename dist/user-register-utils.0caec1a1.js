...
},{"process":"node_modules/process/browser.js"}],"config/index.js":[function(require,module,exports) {
"use strict";
...
exports.HOST = void 0;
var HOST = 'https://semcontrato.herokuapp.com/'; // export const HOST = 'http://localhost:3000/';
...
exports.hasSolitaryChar = hasSolitaryChar;
exports.hasMoreSpace = hasMoreSpace;

function hasNumber(value) {
  for (var aux = 0; aux <= value.length; aux++) {
...
},{}],"js/user-register-utils.js":[function(require,module,exports) {
"use strict";
...
document.getElementById('birthdate').onkeyup = function () {
  var dateHolder = document.getElementById('birthdate');
  var dateValue = document.getElementById('birthdate').value;
...
document.getElementById('file_send').onblur = function () {
  var photoHolder = document.getElementById('custom-text');
  var photoValue = photoHolder.textContent;
...
function nameValidator() {
  ...
  var namemessage = document.querySelector("#namevalidator");

  if (value == null || value.length < 2 || (0, _index2.hasNumber)(value) || (0, _index2.hasMoreSpace)(value) || (0, _index2.hasSolitaryChar)(value)) {
    status = false;
...
function lastnameValidator() {
  ...
  var value = document.querySelector("#lastname").value;
  var lastnamemessage = document.querySelector("#lastnamevalidator");
...
function birthdateValidator() {
  ...
  var value = document.querySelector("#birthdate").value;
  var birthdatemessage = document.querySelector("#birthdatevalidator");
  var birthdateValue = new Date(value);
  var nowValue = new Date(Date.now());
  var day = birthdateValue.getDate();
  var month = birthdateValue.getMonth();
...
function emailValidator() {
  ...
  var emailmessage = document.querySelector("#emailvalidator");
  var myEmail = value.match(/^[a-zA-Z0-9][a-zA-Z0-9\._-]+@([a-zA-Z0-9\._-]+\.)[a-zA-Z-0-9]{2}/);
  var isEmail = false;
  if (myEmail) isEmail = true;

  if (value == null || (0, _index2.hasNumber)(value) || !isEmail) {
    status = false;
...
function photoValidator() {
  ...
  var value = document.querySelector("#custom-text").textContent;
  var photomessage = document.querySelector("#photovalidator");
  var send = document.querySelector("#file_send");
  var archive = value.split(".");
  var extension = archive[1];
...
function usernameValidator() {
  ...
  var usernamemessage = document.querySelector("#usernamevalidator");

  if (value == null || value.length < 2 || (0, _index2.hasSpace)(value) || (0, _index2.hasSolitaryChar)(value)) {
    status = false;
...
function passwordValidator() {
  ...
  var passwordmessage = document.querySelector("#passwordvalidator");

  if (value == null || value.length < 6 || value.length > 8 || (0, _index2.hasSpace)(value) || (0, _index2.hasSolitaryChar)(value)) {
    status = false;
...
function passwordConfirmValidator() {
  var status;
  var password = document.querySelector("#passwordConfirm");
  var value = document.querySelector("#passwordConfirm").value;
  var passwordConfirmmessage = document.querySelector("#passwordconfirmvalidator");
  var getPassword = document.querySelector("#password").value;

  if (value == null || value.length < 6 || value.length > 8 || !value === getPassword || (0, _index2.hasSpace)(value) || (0, _index2.hasSolitaryChar)(value)) {
    status = false;
    password.classList.add("is-invalid");
...
function formValidator() {
  return nameValidator() && lastnameValidator() && birthdateValidator() && emailValidator() && photoValidator() && usernameValidator() && passwordValidator() && passwordConfirmValidator();
} //Integration


var register = document.getElementById('register-new-user');
register.addEventListener('click', function (event) {
  ...
  var dataForm = document.getElementById("user-register");
  var formData = new FormData(dataForm);

  _jquery.default.ajax({
    type: 'POST',
    url: "".concat(_index.HOST, "users/user"),
    contentType: false,
    data: formData,
...
photo.addEventListener("change", function () {
  if (photo.value) {
    customTxt.innerHTML = photo.value.match(/[\/\\]([\w\d\s\.\-\(\)]+)$/)[1];
  } else {
    customTxt.innerHTML = "Nenhuma imagem selecionada.";
  }
});
},{"jquery":"node_modules/jquery/dist/jquery.js","../config/index.js":"config/index.js","../utils/index.js":"utils/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42833" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/user-register-utils.js"], null)
//# sourceMappingURL=/user-register-utils.0caec1a1.js.map