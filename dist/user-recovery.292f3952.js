...
var HelpCenterService = exports.HelpCenterService = function () {
    ...
    _createClass(HelpCenterService, [{
        ...
        value: function list(page) {
            return fetch(_index.HOST + 'helps/post/list/' + page, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
        ...
        value: function findByTitle(title) {
            return fetch(_index.HOST + 'helps/post/title', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
        ...
        value: function findByDesc(desc) {
            return fetch(_index.HOST + 'helps/post/desc', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
...
var HelpCenterAskService = exports.HelpCenterAskService = function () {
    ...
    _createClass(HelpCenterAskService, [{
        ...
        key: 'list',
        value: function list(page) {
            return fetch(_index.HOST + 'helps/ask/list/' + page, {
                method: 'GET',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
...
},{}],"app/js/controllers/PasswordRecoveryController.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.PasswordRecoveryController = undefined;
...
var PasswordRecoveryController = exports.PasswordRecoveryController = function () {
    function PasswordRecoveryController() {
        _classCallCheck(this, PasswordRecoveryController);
        ...
        this.changePasswordVals = [(0, _index2.validate)(this.email, vals.email), (0, _index2.validate)(this.password, vals.password), (0, _index2.validate)(this.passwordConfirm, vals.passwordConfirm, this.password)];
    }

    _createClass(PasswordRecoveryController, [{
        key: 'changePassword',
        value: function changePassword(event) {
            event.preventDefault();
            if ((0, _listCheck.noFalse)(this.changePasswordVals)) {
                var url_string = window.location.href;
                var url = new URL(url_string);
                var URL_KEY = url.searchParams.get("key");
...
var changePassword = document.getElementById("recoverycodeT");
if (changePassword) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/js/user-recovery.js"], null)
//# sourceMappingURL=/user-recovery.292f3952.map