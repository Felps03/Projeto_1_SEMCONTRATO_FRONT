...
var User = function User(name, lastName, userName, email, photo, password, dateOfBirth) {
...
function () {
  ...
  _createClass(UserService, [{
    ...
    value: function editar(id) {
      ...
      $.ajax({
        type: 'PUT',
        url: "".concat(_index.HOST, "users/user/").concat(id),
        contentType: false,
        cache: false,
        processData: false,
        data: formData,
    ...
    value: function changePassword(email, password) {
      ...
      $.ajax({
        type: 'PUT',
        url: "".concat(_index.HOST, "users/changePassword"),
        contentType: false,
        cache: false,
        processData: false,
        data: formData,
    ...
    value: function findByEmail(email) {
      $.ajax({
        type: 'GET',
        url: "".concat(_index.HOST, "users/").concat(email),
        contentType: false,
        cache: false,
        processData: false,
        success: function success(data) {
...
},{"../models/User":"app/js/models/User.js","../services/UserService":"app/js/services/UserService.js"}],"app/js/app.js":[function(require,module,exports) {
"use strict";
