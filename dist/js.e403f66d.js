...
},{"./Authenticate":"app\\js\\models\\Authenticate.js","./User":"app\\js\\models\\User.js","./DailyNote":"app\\js\\models\\DailyNote.js"}],"app\\js\\config\\index.js":[function(require,module,exports) {
'use strict';
...
var AuthenticateService = exports.AuthenticateService = function () {
    ...
    _createClass(AuthenticateService, [{
        ...
        value: function authenticate(email, password) {
            ...
            $.ajax({
                type: 'POST',
                url: _index.HOST + 'users/authenticate',
                contentType: false,
                cache: false,
                processData: false,
                data: formData,
        ...
        value: function resetPassword(email) {
            var form = document.getElementById('recovery-pass-form');
            var formData = new FormData(form);
            $.ajax({
                type: 'POST',
                url: _index.HOST + 'users/user/recover',
                contentType: false,
                cache: false,
                processData: false,
                data: formData,
        ...
        key: 'verifyCode',
        value: function verifyCode(codigo, email) {
            var form = document.getElementById('recovery-code-form');
            var formData = new FormData(form);
            $.ajax({
                type: 'POST',
                url: _index.HOST + 'users/code/verify',
                contentType: false,
                cache: false,
                processData: false,
                data: formData,
...
var AuthenticateController = exports.AuthenticateController = function () {
    ...
    _createClass(AuthenticateController, [{
        ...
        value: function authenticate(event) {
            ...
            var authenticate = new _index.Authenticate(this.email.value.toString(), this.password.value.toString());
            var authenticateService = new _AuthenticateService.AuthenticateService();
            var usuario = authenticateService.authenticate(this.email.value.toString(), this.password.value.toString());
...
},{"../models/index":"app\\js\\models\\index.js","../services/AuthenticateService":"app\\js\\services\\AuthenticateService.js"}],"app\\js\\services\\UserService.js":[function(require,module,exports) {
'use strict';
...
},{"../models/User":"app\\js\\models\\User.js","../services/UserService":"app\\js\\services\\UserService.js"}],"app\\js\\index.js":[function(require,module,exports) {
"use strict";
...
},{"./controllers/AuthenticateController":"app\\js\\controllers\\AuthenticateController.js","./controllers/UserController":"app\\js\\controllers\\UserController.js"}],"node_modules\\parcel-bundler\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/js.e403f66d.map